...
\begin{tikzpicture}[
    ...
    % =========================================================================
    \node[domainLabel] at (-8.5, 7.6) {IDENTIDAD Y SEGURIDAD\\Sprint 1};
    \node[domainLabel, text=colorSucreDark] at (1.0, 7.6) {WORKFLOW Y GESTIÓN DOCUMENTAL\\Sprint 2};
    \node[domainLabel, text=colorInfo] at (10.5, 7.6) {CATÁLOGOS INSTITUCIONALES\\DBNotasCMS};
    ...
    \node (usuario_roles) at (-6.2, -6.2) [entity] {
    ...
    \node (tramites) at (-1.5, -0.6) [entityNew] {
        \begin{tabular}{>{\raggedright\arraybackslash}p{4.8cm}}
            ...
            \hline
            \scriptsize\ttfamily \textbf{PK} id : INT (AI)\\
            \scriptsize\ttfamily \textbf{UQ} numero\_correlativo / gestion\\
            \scriptsize\ttfamily \textbf{FK} tipo\_proceso\_id : INT\\
            \scriptsize\ttfamily estado / tipo\_corres : VARCHAR(30)\\
            ...
            \scriptsize\ttfamily fecha\_creacion / fecha\_conclusion
        \end{tabular}
    };

    \node (correlativos) at (-1.5, -6.2) [entityNew] {
        \begin{tabular}{>{\raggedright\arraybackslash}p{4.4cm}}
    ...
    \node (movimientos) at (4.5, -0.6) [entityNew] {
        \begin{tabular}{>{\raggedright\arraybackslash}p{4.7cm}}
            ...
            \scriptsize\ttfamily orden / tipo\_movimiento\\
            \scriptsize\ttfamily \textbf{FK} usuario\_origen\_id / destino\_id\\
            \scriptsize\ttfamily \textbf{FK} ubicacion\_origen\_id / destino\_id\\
    ...
    \node (adjuntos) at (4.5, -6.2) [entityNew] {
        \begin{tabular}{>{\raggedright\arraybackslash}p{4.7cm}}
            ...
            \scriptsize\ttfamily tipo\_mime / tamano\_bytes\\
    ...
    \node (templeados) at (10.5, -6.2) [entityNew] {
        \begin{tabular}{>{\raggedright\arraybackslash}p{4.0cm}}
    ...
    \draw[relNew] (tramites.south east) -- ++(0.5,-0.5) -| (adjuntos.west)
        node[card, pos=0.08, left] {1}
        node[card, near end, above] {0..N};
    ...
    \draw[dependency] (templeados.south) -- ++(0,-0.7) -- (-13.0,-8.4) |- (usuarios.west)
        node[relLabel, pos=0.48, below=2pt] {sincroniza funcionarios};
