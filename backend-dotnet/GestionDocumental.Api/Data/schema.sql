-- ==============================================================================
-- SISTEMA DE GESTIÓN DOCUMENTAL Y TRÁMITES - ESQUEMA DE BASE DE DATOS (MySQL 8.0+)
-- ==============================================================================

CREATE DATABASE IF NOT EXISTS `gestion_documental_db` 
  CHARACTER SET utf8mb4 
  COLLATE utf8mb4_unicode_ci;

USE `gestion_documental_db`;
